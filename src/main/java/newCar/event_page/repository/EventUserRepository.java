...
public interface EventUserRepository extends JpaRepository<EventUser,Long> {
    ...
    EventUser findByUserIdAndEventId(@Param("userId") Long userId , @Param("eventId") Long eventId);

    @Query(value = "select count(*) from event_user where event_id = :eventId" , nativeQuery = true)
    int getSize(@Param("eventId") Long eventId);
}
